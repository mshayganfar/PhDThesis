...
lower). The questions and their p-values are provided in Table
\ref{fig:31questions-table}. Analysis of the results revealed no statistically
...
the R$^2$ when the number of parameters increased. Questions that are excluded
from the table did no have any statistically significant models based on age and
gender.
