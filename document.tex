...
There are three components involved as the activation criteria for each coping
strategy. The first criterion is the conjunction of emotion valances for the
self and the other collaborator (see Emotion Valance column in Figure
\ref{fig:coping_strategies}). For instance, if the valance of the other
collaborator's emotion is \textit{negative} \textbf{and} the valance of the
robot's emotion is also \textit{negative}, the active coping, acceptance, and
mental disengagement coping strategies are going to be the coping strategy
candidates to become activated if the other activation criteria exist for any of
them.
